...
class DialogLumensQUESHDominantLUSSL(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensQUESHDominantLUSSL, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS QUES-H Dominant Land Use, Soil, Slope'
    ...
    def setupUi(self, parent):
        super(DialogLumensQUESHDominantLUSSL, self).setupUi(self)
