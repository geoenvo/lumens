...
class DialogLumensSCIENDOCalculateTransitionMatrix(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensSCIENDOCalculateTransitionMatrix, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS SCIENDO Calculate Transition Matrix'
    ...
    def setupUi(self, parent):
        super(DialogLumensSCIENDOCalculateTransitionMatrix, self).setupUi(self)
    ...
    def handlerLumensDialogSubmit(self):
        ...
        if self.validDialogForm():
            ...
            outputs = general.runalg(
                'modeler:sciendo1_calculate_transition_matrix',
