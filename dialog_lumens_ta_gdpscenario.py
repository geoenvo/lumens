...
class DialogLumensTARegionalEconomyGDPChangeMultiplierAnalysis(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensTARegionalEconomyGDPChangeMultiplierAnalysis, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS TA Regional Economy GDP Change Multiplier Analysis'
        ...
        self.buttonSelectGDPChangeScenario.clicked.connect(self.handlerSelectGDPChangeScenario)
        self.buttonLumensDialogSubmit.clicked.connect(self.handlerLumensDialogSubmit)
    
    
    def setupUi(self, parent):
        super(DialogLumensTARegionalEconomyGDPChangeMultiplierAnalysis, self).setupUi(self)
        ...
        self.labelGDPChangeScenario = QtGui.QLabel(parent)
        self.labelGDPChangeScenario.setText('GDP change scenario:')
        layoutLumensDialog.addWidget(self.labelGDPChangeScenario, 22, 0)
        
        self.lineEditGDPChangeScenario = QtGui.QLineEdit(parent)
        self.lineEditGDPChangeScenario.setReadOnly(True)
        layoutLumensDialog.addWidget(self.lineEditGDPChangeScenario, 22, 1)
        
        self.buttonSelectGDPChangeScenario = QtGui.QPushButton(parent)
        self.buttonSelectGDPChangeScenario.setText('Select &GDP Change Scenario')
        layoutLumensDialog.addWidget(self.buttonSelectGDPChangeScenario, 23, 0, 1, 2)
    ...
    def setAppSettings(self):
        ...
        self.main.appSettings[type(self).__name__]['gdpChangeScenario'] = unicode(self.lineEditGDPChangeScenario.text())
    ...
    def handlerSelectGDPChangeScenario(self):
        """Select GDP Change Scenario
        """
        file = unicode(QtGui.QFileDialog.getOpenFileName(
            self, 'Select GDP Change Scenario', QtCore.QDir.homePath(), 'GDP Change Scenario (*{0})'.format(self.main.appSettings['selectCsvfileExt'])))
        
        if file:
            self.lineEditGDPChangeScenario.setText(file)
    ...
    def handlerLumensDialogSubmit(self):
        ...
        if self.validDialogForm():
            ...
            outputs = general.runalg(
                ...
                self.main.appSettings[type(self).__name__]['gdpChangeScenario'],
