...
class DialogLumensTAOpportunityCostCurve(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensTAOpportunityCostCurve, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS TA Opportunity Cost Curve'
    ...
    def setupUi(self, parent):
        super(DialogLumensTAOpportunityCostCurve, self).setupUi(self)
