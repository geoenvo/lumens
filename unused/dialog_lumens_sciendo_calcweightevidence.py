...
class DialogLumensSCIENDOCalculateWeightofEvidence(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensSCIENDOCalculateWeightofEvidence, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS SCIENDO Calculate Weight of Evidence'
    ...
    def setupUi(self, parent):
        super(DialogLumensSCIENDOCalculateWeightofEvidence, self).setupUi(self)
    ...
    def handlerLumensDialogSubmit(self):
        ...
        if self.validDialogForm():
            ...
            outputs = general.runalg(
                'modeler:sciendo3_calculate_weight_of_evidence',
