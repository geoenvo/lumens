...
class DialogLumensQUESHMultipleHRU(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensQUESHMultipleHRU, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS QUES-H Multiple HRU'
    ...
    def setupUi(self, parent):
        super(DialogLumensQUESHMultipleHRU, self).setupUi(self)
        ...
        self.labelLandUseThreshold = QtGui.QLabel(parent)
        self.labelLandUseThreshold.setText('Land use &threshold:')
        layoutLumensDialog.addWidget(self.labelLandUseThreshold, 18, 0)
        
        self.spinBoxLandUseThreshold = QtGui.QSpinBox(parent)
        self.spinBoxLandUseThreshold.setRange(0, 99999)
        self.spinBoxLandUseThreshold.setValue(0)
        layoutLumensDialog.addWidget(self.spinBoxLandUseThreshold, 18, 1)
        
        self.labelLandUseThreshold.setBuddy(self.spinBoxLandUseThreshold)
        
        self.labelSoilThreshold = QtGui.QLabel(parent)
        self.labelSoilThreshold.setText('Soil t&hreshold:')
        layoutLumensDialog.addWidget(self.labelSoilThreshold, 19, 0)
        
        self.spinBoxSoilThreshold = QtGui.QSpinBox(parent)
        self.spinBoxSoilThreshold.setRange(0, 99999)
        self.spinBoxSoilThreshold.setValue(0)
        layoutLumensDialog.addWidget(self.spinBoxSoilThreshold, 19, 1)
        
        self.labelSoilThreshold.setBuddy(self.spinBoxSoilThreshold)
        
        self.labelSlopeThreshold = QtGui.QLabel(parent)
        self.labelSlopeThreshold.setText('Slope th&reshold:')
        layoutLumensDialog.addWidget(self.labelSlopeThreshold, 20, 0)
        
        self.spinBoxSlopeThreshold = QtGui.QSpinBox(parent)
        self.spinBoxSlopeThreshold.setRange(0, 99999)
        self.spinBoxSlopeThreshold.setValue(0)
        layoutLumensDialog.addWidget(self.spinBoxSlopeThreshold, 20, 1)
        
        self.labelSlopeThreshold.setBuddy(self.spinBoxSlopeThreshold)
        
        self.buttonLumensDialogSubmit = QtGui.QPushButton(parent)
        self.buttonLumensDialogSubmit.setText(self.dialogTitle)
        layoutLumensDialog.addWidget(self.buttonLumensDialogSubmit, 21, 0, 1, 2)
