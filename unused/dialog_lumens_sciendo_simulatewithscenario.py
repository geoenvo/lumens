...
class DialogLumensSCIENDOSimulateWithScenario(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensSCIENDOSimulateWithScenario, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS SCIENDO Simulate With Scenario'
    ...
    def setupUi(self, parent):
        super(DialogLumensSCIENDOSimulateWithScenario, self).setupUi(self)
    ...
    def handlerLumensDialogSubmit(self):
        ...
        if self.validDialogForm():
            ...
            outputs = general.runalg(
                'modeler:sciendo5_simulate_with_scenario',
