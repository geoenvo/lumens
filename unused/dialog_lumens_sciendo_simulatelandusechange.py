...
class DialogLumensSCIENDOSimulateLandUseChange(DialogLumensBase):
    """
    """
    
    
    def __init__(self, parent):
        super(DialogLumensSCIENDOSimulateLandUseChange, self).__init__(parent)
        
        self.dialogTitle = 'LUMENS SCIENDO Simulate Land Use Change'
    ...
    def setupUi(self, parent):
        super(DialogLumensSCIENDOSimulateLandUseChange, self).setupUi(self)
    ...
    def handlerLumensDialogSubmit(self):
        ...
        if self.validDialogForm():
            ...
            outputs = general.runalg(
                'modeler:sciendo4_simulate_land_use_change',
